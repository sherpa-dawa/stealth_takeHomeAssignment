      ...
      <CardContent className="p-3 sm:p-4 lg:p-5 space-y-3 sm:space-y-4 flex flex-col h-full">
        ...
        <div className="flex gap-1 sm:gap-1.5 pt-2 mt-auto flex-wrap">
          ...
          <Button
            ...
            className={`h-6 sm:h-7 px-1.5 sm:px-2 text-xs ${getColorClass("text", componentColors.button.success.text)} hover:${getColorClass("bg", componentColors.button.success.hover)} flex-1 sm:flex-none`}
            title="Mark complete"
          >
